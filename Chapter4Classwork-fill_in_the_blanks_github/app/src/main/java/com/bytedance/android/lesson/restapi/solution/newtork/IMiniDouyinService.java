...
public interface IMiniDouyinService {
    ...
    public static final String HOST = "http://10.108.10.39:8080/";
    @POST("/minidouyin/video")
    @Multipart
    Call<PostVideoResponse> createVideo(@Query("student_id") String str, @Query("user_name") String str2, @Part MultipartBody.Part part, @Part MultipartBody.Part part2);
    @GET("/minidouyin/feed")
